...
- Conservative Hot-Apply classification for config/utility mods only.
- Restart-required classification for DLL/PCK/UI/gameplay/unknown mods.
...
The in-game Hot-Apply feature is conservative. It only saves safe settings state for eligible config/utility mods. It does not true-load previously unloaded DLL/PCK mods.
...
TestMods/                                        Controlled manifests for hot-apply classification tests
MANUAL_TEST_0.4.0.md                             Manual test checklist
GOAL_NEXT_STAGE_HOT_RELOAD.md                    Design/goal notes
